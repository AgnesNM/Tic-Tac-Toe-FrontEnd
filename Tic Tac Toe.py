...
#store x and o into variable
xPhoto = PhotoImage(file='x.png')
oPhoto = PhotoImage(file='o.png')

#main game function
def game():
    button1 = Button(root, height=9, width=19,relief='ridge',borderwidth=5,background='#EFBBFF', textvariable=btn1,command=lambda:btn_press(1,0,0))
...
#function to check the pressed button
